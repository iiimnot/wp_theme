...
function health_service_info_page() {
  ...
  <div class="wrap about-wrap one-pageily-add-css">
      ...
      <div class="feature-section three-col">
        <div class="col">
          <div class="widgets-holder-wrap">
            <h3><?php echo __("Free Theme Demo", "health-service" ); ?></h3>
            <p><?php echo __("You can check our free theme demo before start customization. Also you can download demo data as shown in demo", "health-service" ); ?></p>
            <p><a target="blank" href="<?php echo esc_url('https://testerwp.com/demo/health-service/', 'health-service'); ?>" class="button button-primary">
              <?php echo __("Free Theme Demo", "health-service" ); ?>
            </a></p>
          </div>
        </div>
        <div class="col">
    ...
    <div class="one-pageily-button-container">
      <a target="blank" href="<?php echo esc_url('https://testerwp.com/product/medical-elementor-pro/', 'health-service'); ?>" class="button button-primary">
        <?php echo __("Read Full Description", "health-service" ); ?>
      </a>
      <a target="blank" href="<?php echo esc_url('https://testerwp.com/lp/medical-elementor-pro-preview/', 'health-service'); ?>" class="button button-primary">
