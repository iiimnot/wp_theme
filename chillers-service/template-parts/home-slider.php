 ...
 */
	...
	for( $i = 1; $i <= $health_service_slider_no; $i++ ) {
		 ...
		 $health_service_slider_page_btn_txt[]    =  get_theme_mod( "health_service_slider_page_btn_txt_$i" );
		 $health_service_slider_page_second_btn_txt[]    =  get_theme_mod( "health_service_slider_page_second_btn_txt_$i" );
		 $health_service_slider_page_btn_url[]    =  get_theme_mod( "health_service_slider_page_btn_url_$i" );
		 $health_service_slider_page_second_btn_url[]    =  get_theme_mod( "health_service_slider_page_second_btn_url_$i" );
        ...
        <div class="home-area">
            <div class="container-fluid m-0 p-0">
                <div class="home-slider owl-carousel owl-theme">
					...
					?> 
						<div class="slider-item item-bg1" style="background-image: url(<?php echo esc_url(get_the_post_thumbnail_url()); ?>);">
