...
function medical_service_child_css() {
    ...
    wp_enqueue_style( 'medical-service-child-style',get_stylesheet_directory_uri() . '/assets/css/child.css');
	wp_enqueue_script( 'medical-service-custom-script', get_stylesheet_directory_uri() . '/assets/js/custom-script.js');
